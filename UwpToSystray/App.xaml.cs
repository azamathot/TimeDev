...
namespace UwpToSystray
{
    public partial class App
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            _notifyIcon.Icon = UwpToSystray.Properties.Resources.TrayIcon;
        ...
        private void CreateContextMenu()
        {
            ...
            _notifyIcon.ContextMenuStrip.Items.Add("Exit",
                UwpToSystray.Properties.Resources.TrayIcon.ToBitmap()).Click +=
                (s, e) => ExitApplication();
        }
        ...
        private void ToggleWindow()
        {
            ...
            if (MainWindow == null)
            {
                ...
                ((FormsApplicationPage)MainWindow).LoadApplication(new TimeDev.App());
                MainWindow.Closing += MainWindow_Closing;
